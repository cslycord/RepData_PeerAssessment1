...
```
The mean and median of the total steps per day are `r MeanData` and `r MedianData`.
...
The maximum of the average number of is held in interval `r MaxMeanSteps`.
...
```
The mean and median of the total steps (w/ missing values inputted) per day are `r CleanMeanData` and `r CleanMedianData`.
